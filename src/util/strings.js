...
const strings = {
    ...
    cleanDryWaste: 'Aprovechamiento inorganico: Residuos limpios y secos como: plástico, vidrio, metales, papel y cartón.',
    contaminatedWaste: 'Disposición inservible: Papel higiénico, servilletas, papeles y cartones contaminados con comida; papeles metalizados, entre otros; residuos COVID-19 como tapabocas, guantes, entre otros.',
    foodWaste: 'Aprovechamiento organico: Restos de comida, residuos de corte de césped y poda de jardín, etc.',
    inorganicRecycling: 'Aprovechamiento inorgánico',
    unusableWasteDisposal: 'Disposición inservible',
    organicRecycling: 'Aprovechamiento orgánico',
